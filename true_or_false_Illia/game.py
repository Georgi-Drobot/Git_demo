...
from true_or_false_Illia.question import Question
...
class Game:
    ...
    def __init__(self, file_path: str, end_of_game_event: Callable, allowed_mistakes: int):
        ...
        self.__fill_in_questions(file_path, self.__questions)  # function in __init__ it is bad practice
    ...
    def give_answer(self, answer: bool):
        ...
        if self.is_last_question() or exceeded_allowed_mistakes():
            ...
            # (Ctrl + Whitespace) * 2 -> Autocomplete not imported name
